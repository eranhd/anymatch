...
var MessageService = (function (_super) {
    ...
    function MessageService(http, authService, userService) {
        ...
        _this.conversations = [];
        _this._currentConversation = new ReplaySubject_1.ReplaySubject();
        _this.numOfNewMessage = new ReplaySubject_1.ReplaySubject();
        _this.recent = new ReplaySubject_1.ReplaySubject();
