...
var DashboardComponent = (function () {
    function DashboardComponent(schoolService, authService, fb, layerService, classService, userService, dialog) {
        ...
        this.layerService.layers.subscribe(function (res) {
            _this.dataSource = new __WEBPACK_IMPORTED_MODULE_4__angular_material__["v" /* MatTableDataSource */](res);
        });
    }
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])(__WEBPACK_IMPORTED_MODULE_4__angular_material__["o" /* MatPaginator */]),
